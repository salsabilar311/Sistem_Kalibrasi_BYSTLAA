      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Fluke 177</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">300.000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="300.000 mV" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="6 A" readonly required>
                          <td class="text-end">3.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3.00000 A" readonly required></td>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tr class="text-center">
                          ...
                          <td rowspan="4">6 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="6 A" readonly required></td>
                          <td class="text-end">1.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="6 A" readonly required>
                          <td class="text-end">2.0000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="2.0000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="6 A" readonly required>
                          <td class="text-end">3.0000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3.0000 A" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1.0000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.0000 KΩ" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td rowspan="2">999.9 Hz<input type="hidden" style="width: 100px" name="range[]" id="range" value="999.99 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">500.00 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="500.00 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">5.0000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="5.0000 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="99.99 KHz" readonly required>
                          <td class="text-end">50.000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="50.000 KHz" readonly required></td>
