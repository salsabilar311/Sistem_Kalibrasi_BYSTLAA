      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Sanwa CD772</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td rowspan="13">Tegangan DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required></td>
                          <td rowspan="3">400 mV<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mV" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mV" readonly required>
                          <td class="text-end">200.0000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="200.0000 mV" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">4 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="4 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="4 V" readonly required>
                          <td class="text-end">2.000000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="2.000000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">40 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="40 V" readonly required>
                          <td class="text-end">20.00000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="20.00000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">400 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="400 V" readonly required>
                          <td class="text-end">500.0000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="500.0000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">600 V</td><input type="hidden" style="width: 100px" name="range[]" id="range" value="600 V" readonly required></td>
                          <td class="text-end">900.000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="900.000 V" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="10">Tegangan AC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan AC" readonly required></td>
                          <td rowspan="3">4 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="4 V" readonly required></td>
                          <td class="text-end">1.00000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00000 mV" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="4 V" readonly required>
                          <td class="text-end">2.00000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="2.00000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan AC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="40 V" readonly required>
                          <td class="text-end">20.0000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="20.0000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">900.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="900.00 V" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="7">Arus DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required></td>
                          <td rowspan="1">400 μA<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 μA" readonly required></td>
                          <td class="text-end">350.000 μA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="350.000 μA" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td rowspan="1">4000 μA<input type="hidden" style="width: 100px" name="range[]" id="range" value="4000 μA" readonly required></td>
                          <td class="text-end">3500.000 μA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3500.000 μA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="1">40 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required></td>
                          <td class="text-end">35.000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="35.000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="1">400 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="1">4 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="4 A" readonly required></td>
                          <td class="text-end">3.500 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3.500 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="1">10 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="10 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="1">15 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="15 A" readonly required></td>
                          <td class="text-end">13.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="13.000 A" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td rowspan="2">400 Ω<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="400 Ω" readonly required>
                          <td class="text-end">100.000 Ω<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.000 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">4 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="4 KΩ" readonly required></td>
                          <td class="text-end">1.000000 Ω<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.000000 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">40 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 KΩ" readonly required></td>
                          <td class="text-end">10.00000 Ω<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00000 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">400 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 KΩ" readonly required></td>
                          <td class="text-end">100.0000 Ω<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.0000 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">40 MΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 MΩ" readonly required></td>
                          <td class="text-end">1.000000 MΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.000000 MΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">40 MΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 MΩ" readonly required></td>
                          <td class="text-end">10.00000 MΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00000 MΩ" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="8">Frekuensi<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required></td>
                          <td rowspan="1">50.00 Hz<input type="hidden" style="width: 100px" name="range[]" id="range" value="50.00 Hz" readonly required></td>
                          <td class="text-end">50.000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="50.000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td rowspan="2">500 Hz<input type="hidden" style="width: 100px" name="range[]" id="range" value="500 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="500 Hz" readonly required>
                          <td class="text-end">300.00 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="300.00 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <td rowspan="2">5 KHz<input type="hidden" style="width: 100px" name="range[]" id="range" value="5 KHz" readonly required></td>
                          <td class="text-end">1.00000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00000 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="5 Hz" readonly required>
                          <td class="text-end">3.0000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3.0000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <td rowspan="2">50 KHz<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="50 KHz" readonly required>
                          <td class="text-end">30.000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30.000 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <td rowspan="1">100 KHz<input type="hidden" style="width: 100px" name="range[]" id="range" value="100 KHz" readonly required></td>
                          <td class="text-end">60.000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="60.000 KHz" readonly required></td>
