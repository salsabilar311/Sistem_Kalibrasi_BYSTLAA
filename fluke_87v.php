        ...
        <div class="sidebar" id="side_nav">
          ...
          <div class="menu">
            <ul class="list-unstyled pt-3">
              ...
              <li class=""><a href="progres.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-chart-bar"></i> Form Progress Kalibrasi</a></li>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x2-29" name="x2[]" oninput="calculateAVG(29)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-29" name="x3[]" oninput="calculateAVG(29)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-29" name="x4[]" oninput="calculateAVG(29)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-29" name="x5[]" oninput="calculateAVG(29)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-29" name="x6[]" oninput="calculateAVG(29)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x2-30" name="x2[]" oninput="calculateAVG(30)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-30" name="x3[]" oninput="calculateAVG(30)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-30" name="x4[]" oninput="calculateAVG(30)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-30" name="x5[]" oninput="calculateAVG(30)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-30" name="x6[]" oninput="calculateAVG(30)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x2-31" name="x2[]" oninput="calculateAVG(31)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-31" name="x3[]" oninput="calculateAVG(31)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-31" name="x4[]" oninput="calculateAVG(31)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-31" name="x5[]" oninput="calculateAVG(31)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-31" name="x6[]" oninput="calculateAVG(31)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x2-32" name="x2[]" oninput="calculateAVG(32)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-32" name="x3[]" oninput="calculateAVG(32)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-32" name="x4[]" oninput="calculateAVG(32)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-32" name="x5[]" oninput="calculateAVG(32)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-32" name="x6[]" oninput="calculateAVG(32)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x2-33" name="x2[]" oninput="calculateAVG(33)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-33" name="x3[]" oninput="calculateAVG(33)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-33" name="x4[]" oninput="calculateAVG(33)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-33" name="x5[]" oninput="calculateAVG(33)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-33" name="x6[]" oninput="calculateAVG(33)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x2-34" name="x2[]" oninput="calculateAVG(34)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-34" name="x3[]" oninput="calculateAVG(34)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-34" name="x4[]" oninput="calculateAVG(34)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-34" name="x5[]" oninput="calculateAVG(34)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-34" name="x6[]" oninput="calculateAVG(34)" required></td>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tr class="text-center">
                          ...
                          <td>500 μA<input type="hidden" style="width: 100px" name="range[]" id="range" value="500 μA" readonly required></td>
                          <td class="text-end">400.000 μA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="400.000 μA" readonly required></td>
                          <td><input type="text" style="width: 100px" id="x1-35" name="x1[]" oninput="calculateAVG(35)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-35" name="x2[]" oninput="calculateAVG(35)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-35" name="x3[]" oninput="calculateAVG(35)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-35" name="x4[]" oninput="calculateAVG(35)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-35" name="x5[]" oninput="calculateAVG(35)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-35" name="x6[]" oninput="calculateAVG(35)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>5000 μA<input type="hidden" style="width: 100px" name="range[]" id="range" value="5000 μA" readonly required></td>
                          <td class="text-end">4000.000 μA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="4000.000 μA" readonly required></td>
                          <td><input type="text" style="width: 100px" id="x1-36" name="x1[]" oninput="calculateAVG(36)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-36" name="x2[]" oninput="calculateAVG(36)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-36" name="x3[]" oninput="calculateAVG(36)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-36" name="x4[]" oninput="calculateAVG(36)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-36" name="x5[]" oninput="calculateAVG(36)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-36" name="x6[]" oninput="calculateAVG(36)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>50 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 mA" readonly required></td>
                          <td class="text-end">40.000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="40.000 mA" readonly required></td>
                          <td><input type="text" style="width: 100px" id="x1-37" name="x1[]" oninput="calculateAVG(37)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-37" name="x2[]" oninput="calculateAVG(37)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-37" name="x3[]" oninput="calculateAVG(37)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-37" name="x4[]" oninput="calculateAVG(37)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-37" name="x5[]" oninput="calculateAVG(37)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-37" name="x6[]" oninput="calculateAVG(37)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>400 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mA" readonly required></td>
                          <td class="text-end">350.000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="350.000 mA" readonly required></td>
                          <td><input type="text" style="width: 100px" id="x1-38" name="x1[]" oninput="calculateAVG(38)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-38" name="x2[]" oninput="calculateAVG(38)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-38" name="x3[]" oninput="calculateAVG(38)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-38" name="x4[]" oninput="calculateAVG(38)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-38" name="x5[]" oninput="calculateAVG(38)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-38" name="x6[]" oninput="calculateAVG(38)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>5 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="5 A" readonly required></td>
                          <td class="text-end">4.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="4.000 A" readonly required></td>
                          <td><input type="text" style="width: 100px" id="x1-39" name="x1[]" oninput="calculateAVG(39)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-39" name="x2[]" oninput="calculateAVG(39)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-39" name="x3[]" oninput="calculateAVG(39)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-39" name="x4[]" oninput="calculateAVG(39)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-39" name="x5[]" oninput="calculateAVG(39)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-39" name="x6[]" oninput="calculateAVG(39)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>10 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="10 A" readonly required></td>
                          <td class="text-end">9.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="9.000 A" readonly required></td>
                          <td><input type="text" style="width: 100px" id="x1-40" name="x1[]" oninput="calculateAVG(40)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-40" name="x2[]" oninput="calculateAVG(40)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-40" name="x3[]" oninput="calculateAVG(40)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-40" name="x4[]" oninput="calculateAVG(40)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-40" name="x5[]" oninput="calculateAVG(40)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-40" name="x6[]" oninput="calculateAVG(40)" required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-48" name="x1[]" oninput="calculateAVG(48)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-48" name="x2[]" oninput="calculateAVG(48)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-48" name="x3[]" oninput="calculateAVG(48)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-48" name="x4[]" oninput="calculateAVG(48)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-48" name="x5[]" oninput="calculateAVG(48)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-48" name="x6[]" oninput="calculateAVG(48)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-49" name="x1[]" oninput="calculateAVG(49)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-49" name="x2[]" oninput="calculateAVG(49)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-49" name="x3[]" oninput="calculateAVG(49)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-49" name="x4[]" oninput="calculateAVG(49)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-49" name="x5[]" oninput="calculateAVG(49)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-49" name="x6[]" oninput="calculateAVG(49)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-50" name="x1[]" oninput="calculateAVG(50)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-50" name="x2[]" oninput="calculateAVG(50)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-50" name="x3[]" oninput="calculateAVG(50)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-50" name="x4[]" oninput="calculateAVG(50)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-50" name="x5[]" oninput="calculateAVG(50)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-50" name="x6[]" oninput="calculateAVG(50)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-51" name="x1[]" oninput="calculateAVG(51)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-51" name="x2[]" oninput="calculateAVG(51)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-51" name="x3[]" oninput="calculateAVG(51)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-51" name="x4[]" oninput="calculateAVG(51)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-51" name="x5[]" oninput="calculateAVG(51)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-51" name="x6[]" oninput="calculateAVG(51)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-52" name="x1[]" oninput="calculateAVG(52)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-52" name="x2[]" oninput="calculateAVG(52)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-52" name="x3[]" oninput="calculateAVG(52)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-52" name="x4[]" oninput="calculateAVG(52)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-52" name="x5[]" oninput="calculateAVG(52)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-52" name="x6[]" oninput="calculateAVG(52)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-53" name="x1[]" oninput="calculateAVG(53)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-53" name="x2[]" oninput="calculateAVG(53)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-53" name="x3[]" oninput="calculateAVG(53)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-53" name="x4[]" oninput="calculateAVG(53)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-53" name="x5[]" oninput="calculateAVG(53)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-53" name="x6[]" oninput="calculateAVG(53)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-54" name="x1[]" oninput="calculateAVG(54)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-54" name="x2[]" oninput="calculateAVG(54)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-54" name="x3[]" oninput="calculateAVG(54)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-54" name="x4[]" oninput="calculateAVG(54)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-54" name="x5[]" oninput="calculateAVG(54)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-54" name="x6[]" oninput="calculateAVG(54)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-55" name="x1[]" oninput="calculateAVG(55)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-55" name="x2[]" oninput="calculateAVG(55)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-55" name="x3[]" oninput="calculateAVG(55)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-55" name="x4[]" oninput="calculateAVG(55)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-55" name="x5[]" oninput="calculateAVG(55)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-55" name="x6[]" oninput="calculateAVG(55)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-56" name="x1[]" oninput="calculateAVG(56)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-56" name="x2[]" oninput="calculateAVG(56)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-56" name="x3[]" oninput="calculateAVG(56)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-56" name="x4[]" oninput="calculateAVG(56)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-56" name="x5[]" oninput="calculateAVG(56)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-56" name="x6[]" oninput="calculateAVG(56)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-57" name="x1[]" oninput="calculateAVG(57)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-57" name="x2[]" oninput="calculateAVG(57)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-57" name="x3[]" oninput="calculateAVG(57)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-57" name="x4[]" oninput="calculateAVG(57)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-57" name="x5[]" oninput="calculateAVG(57)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-57" name="x6[]" oninput="calculateAVG(57)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-58" name="x1[]" oninput="calculateAVG(58)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-58" name="x2[]" oninput="calculateAVG(58)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-58" name="x3[]" oninput="calculateAVG(58)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-58" name="x4[]" oninput="calculateAVG(58)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-58" name="x5[]" oninput="calculateAVG(58)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-58" name="x6[]" oninput="calculateAVG(58)" required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td><input type="text" style="width: 100px" id="x1-59" name="x1[]" oninput="calculateAVG(59)" required></td>
                          <td><input type="text" style="width: 100px" id="x2-59" name="x2[]" oninput="calculateAVG(59)" required></td>
                          <td><input type="text" style="width: 100px" id="x3-59" name="x3[]" oninput="calculateAVG(59)" required></td>
                          <td><input type="text" style="width: 100px" id="x4-59" name="x4[]" oninput="calculateAVG(59)" required></td>
                          <td><input type="text" style="width: 100px" id="x5-59" name="x5[]" oninput="calculateAVG(59)" required></td>
                          <td><input type="text" style="width: 100px" id="x6-59" name="x6[]" oninput="calculateAVG(59)" required></td>
