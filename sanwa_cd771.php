      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Sanwa CD771</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td>400 μA<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 μA" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>4000 μA<input type="hidden" style="width: 100px" name="range[]" id="range" value="4000 μA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td>40 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td>350.000 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="350.000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td>4 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="4 A" readonly required></td>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">4 MΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="4 MΩ" readonly required></td>
