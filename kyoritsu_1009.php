      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Kyoritsu 1009</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1.00000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">10.0000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.0000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">30.000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30.000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">60.000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="60.000 Hz" readonly required></td>
