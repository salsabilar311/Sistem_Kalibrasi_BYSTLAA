      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Sanwa CD800A</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">200.0000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="200.0000 V" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="4 V" readonly required>
                          <td class="text-end">2.00000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="2.00000 mV" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan AC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="400 V" readonly required>
                          <td class="text-end">200.000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="200.000 V" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td rowspan="3">40 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required></td>
                          <td class="text-end">10.00000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required></td>
                          <td class="text-end">20.00000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="20.00000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required>
                          <td class="text-end">30.0000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30.0000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="3">400 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mA" readonly required></td>
                          <td class="text-end">100.0000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.0000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mA" readonly required>
                          <td class="text-end">200.0000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="200.0000 mA" readonly required></td>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tr class="text-center">
                          ...
                          <td rowspan="2">40 mA<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required></td>
                          <td class="text-end">10.0000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.0000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="40 mA" readonly required>
                          <td class="text-end">30.000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30.000 mA" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="400 mA" readonly required>
                          <td class="text-end">100.000 mA<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.000 mA" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">300 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="300 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1000 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">3000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">10000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10000 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">30000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">60000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="60000 Hz" readonly required></td>
