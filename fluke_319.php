                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td rowspan="10">Tegangan DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required></td>
                          <td rowspan="3">2 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="2 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="2 V" readonly required>
                          <td class="text-end">1.500 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.500 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="2 V" readonly required>
                          <td class="text-end">1.800 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.800 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">20 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="20 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="20 V" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="20 V" readonly required>
                          <td class="text-end">18.000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="18.000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">200 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="200 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="200 V" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="200 V" readonly required>
                          <td class="text-end">180.000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="180.000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="1">600 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="600 V" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="9">Arus DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="3">40 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="40 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="2">600 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="600 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="600 A" readonly required>
                          <td class="text-end">750.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="750.000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="1">1000 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="1000 A" readonly required>
                          <td class="text-end">900.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="900.000 A" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                      <tr class="text-center">
                          <td rowspan="9">Arus AC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required></td>
                          <td rowspan="3">2 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="2 A" readonly required></td>
                          <td class="text-end">2.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="2.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required>
                          <td rowspan="1">1000 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="1000 A" readonly required></td>
                          <td class="text-end">900.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="900.000 A" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="3">Resistansi<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required></td>
