                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <tr class="text-center">
                            ...
                            <tr class="text-center">
                              <td class="text-end">180,000 V</td>
                              <td><input type="text" style="width: 100px"></td>
                              <td><input type="text" style="width: 100px"></td>
                              <td><input type="text" style="width: 100px"></td>
                              <td><input type="text" style="width: 100px"></td>
                                          ...
                                          <div class="card-body">
                                            <table class="table-bordered table-sm fs-6" style="width: 100%">
                                              ...
                                              <tbody>
                                                ...
                                                <tr class="text-center">
                                                    <td class="text-end">10,0000 A</td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                ...
                                                <tr class="text-center">
                                                  <td rowspan="3">40 A</td>
                                                    <td class="text-end">20,0000 A</td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                  ...
                                                  <tr class="text-center">
                                                    <td class="text-end">50,0000 A</td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                  ...
                                                  <tr class="text-center">
                                                    <td class="text-end">100,000 A</td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                    <td><input type="text" style="width: 100px"></td>
                                                  ...
                                                  <tr class="text-center">
                                                    <td rowspan="1">600 A</td>
                                                      <td class="text-end">500,000 A</td>
                                                      <td><input type="text" style="width: 100px"></td>
                                                      <td><input type="text" style="width: 100px"></td>
                                                      <td><input type="text" style="width: 100px"></td>
                                                      <td><input type="text" style="width: 100px"></td>
                                                    ...
                                                    <tr class="text-center">
                                                        <td rowspan="2">1000 A</td>
                                                          <td class="text-end">750,000 A</td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                        ...
                                                        <tr class="text-center">
                                                          <td class="text-end">900,000 A</td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                          <td><input type="text" style="width: 100px"></td>
                                                    ...
                                                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="text-end">1,00000 KΩ</td>
                                                            <td><input type="text" style="width: 100px"></td>
                                                            <td><input type="text" style="width: 100px"></td>
                                                            <td><input type="text" style="width: 100px"></td>
                                                            <td><input type="text" style="width: 100px"></td>
