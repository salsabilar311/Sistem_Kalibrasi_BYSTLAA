      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Kyoritsu Kew Snap 2055</h4></div>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="2">1000 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="1000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="1000 A" readonly required>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1.00000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00000 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">10.000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.000 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">10.000 MΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.000 MΩ" readonly required></td>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="999.9 Hz" readonly required>
