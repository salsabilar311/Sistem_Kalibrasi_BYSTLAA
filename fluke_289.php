      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Fluke 289</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td rowspan="11">Tegangan DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required></td>
                          <td rowspan="2">50 mV<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 mV" readonly required></td>
                          <td class="text-end">40.000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="40.000 mV" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="50 mV" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="2">500 mV<input type="hidden" style="width: 100px" name="range[]" id="range" value="500 mV" readonly required></td>
                          <td class="text-end">400.000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="400.000 mV" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="500 mV" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="2">5 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="5 V" readonly required></td>
                          <td class="text-end">4.0000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="4.0000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="5 V" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="2">50 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 V" readonly required></td>
                          <td class="text-end">40.0000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="40.0000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="50 V" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="2">500 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="500 V" readonly required></td>
                          <td class="text-end">400.0000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="400.0000 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="500 V" readonly required>
                          <td class="text-end">600.000 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="600.000 V" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="11">Tegangan AC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan AC" readonly required></td>
                          <td rowspan="2">50 mV<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 mV" readonly required></td>
                          <td class="text-end">40.000 mV<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="40.000 mV" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td>50 Ω<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>500 Ω<input type="hidden" style="width: 100px" name="range[]" id="range" value="500 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1.00 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">50 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="50 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">500 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="500 KΩ" readonly required></td>
                          <td class="text-end">100.00 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.00 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">5 MΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="5 MΩ" readonly required></td>
                          <td class="text-end">1.00 MΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00 MΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">100 MΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="100 MΩ" readonly required></td>
                          <td class="text-end">10.00 MΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00 MΩ" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td>99.99 Hz<input type="hidden" style="width: 100px" name="range[]" id="range" value="99.99 Hz" readonly required></td>
                          <td class="text-end">90.000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="90.000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td>999.99 Hz<input type="hidden" style="width: 100px" name="range[]" id="range" value="999.99 Hz" readonly required></td>
                          <td class="text-end">900.000 Hz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="900.000 Hz" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <td rowspan="3">999.99 KHz<input type="hidden" style="width: 100px" name="range[]" id="range" value="999.99 KHz" readonly required></td>
                          <td class="text-end">90.000 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="90.000 KHz" readonly required></td>
