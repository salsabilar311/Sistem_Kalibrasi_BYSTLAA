      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Fluke 175</h4></div>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <td rowspan="3">1000 V</td><input type="hidden" style="width: 100px" name="range[]" id="range" value="1000 V" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td class="text-end">10.19700 Ω<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.19700 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">100.2200 Ω<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.2200 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">0.9996 MΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="0.9996 MΩ" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">5 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="5 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">10 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10 KHz" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">50 KHz<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="50 KHz" readonly required></td>
