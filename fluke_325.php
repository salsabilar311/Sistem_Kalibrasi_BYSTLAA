      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Fluke 325</h4></div>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td rowspan="9">Tegangan DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required></td>
                          <td rowspan="3">6 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="6 V" readonly required></td>
                          <td class="text-end">1.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">3.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="3.00 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="6 V" readonly required>
                          <td class="text-end">5.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="5.00 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">10.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">30.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30.00 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="60 V" readonly required>
                          <td class="text-end">50.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="50.00 V" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">100.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.00 V" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="9">Tegangan AC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Tegangan AC" readonly required></td>
                          <td rowspan="3">6 V<input type="hidden" style="width: 100px" name="range[]" id="range" value="6 V" readonly required></td>
                          <td class="text-end">1.00 V<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.00 V" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          <td rowspan="10">Arus DC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required></td>
                          <td rowspan="3">2 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="2 A" readonly required></td>
                          <td class="text-end">1.000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="2 A" readonly required></td>
                          <td class="text-end">1.500 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.500 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">1.80000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.80000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="3">20 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="20 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="20 A" readonly required>
                          <td class="text-end">10.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="20 A" readonly required>
                          <td class="text-end">18.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="18.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <td rowspan="3">200 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="200 A" readonly required></td>
                          <td class="text-end">50.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="50.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="200 A" readonly required>
                          <td class="text-end">100.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus DC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="200 A" readonly required>
                          <td class="text-end">180.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="180.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">300.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="300.00000 A" readonly required></td>
                ...
                <form action="" method="POST">
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                      <tr class="text-center">
                          <td rowspan="10">Arus AC<input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required></td>
                          <td rowspan="3">2 A<input type="hidden" style="width: 100px" name="range[]" id="range" value="2 A" readonly required></td>
                          <td class="text-end">1.000000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.000000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="2 A" readonly required>
                          <td class="text-end">1.50000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="1.50000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="20 A" readonly required></td>
                          <td class="text-end">10.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00000 A" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Arus AC" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="200 A" readonly required></td>
                          <td class="text-end">100.00000 A<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="100.00000 A" readonly required></td>
                    ...
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td rowspan="2">200 Ω<input type="hidden" style="width: 100px" name="range[]" id="range" value="200 Ω" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="200 Ω" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">2 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="2 KΩ" readonly required></td>
                          <td class="text-end">2.0000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="2.0000 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">5 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="5 KΩ" readonly required></td>
                          <td class="text-end">5.000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="5.000 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">10 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="10 KΩ" readonly required></td>
                          <td class="text-end">10.00 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="10.00 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Resistensi" readonly required>
                          <td rowspan="1">20 KΩ<input type="hidden" style="width: 100px" name="range[]" id="range" value="20 KΩ" readonly required></td>
                          <td class="text-end">15.0000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="15.0000 KΩ" readonly required></td>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="text-end">30.000 KΩ<input type="hidden" style="width: 100px" name="standar[]" id="standar" value="30.000 KΩ" readonly required></td>
