      ...
      <div class="main-container d-flex">
        ...
        <div class="content">
          ...
          <div class="container-fluid p-4">
            <div class="row">
              <div class="col-6"><h4>Form Input Data Krisbow KW06-270</h4></div>
                  ...
                  <div class="card-body">
                    <table class="table-bordered table-sm fs-6" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <input type="hidden" style="width: 100px" name="range[]" id="range" value="5 KHz" readonly required>
                        ...
                        <tr class="text-center">
                          <input type="hidden" style="width: 100px" name="besaran_ukur[]" id="besaran_ukur" value="Frekuensi" readonly required>
                          <td rowspan="2">100 KHz<input type="hidden" style="width: 100px" name="range[]" id="range" value="100 KHz" readonly required></td>
